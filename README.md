# Awesome Stacks[![Awesome](https://awesome.re/badge.svg)](https://awesome.re) with stars
...
* [Stacking Tracker](https://stacking-tracker.com) - Overview of Stacking and historical data [Source code](https://github.com/StackingDAO/stacking-tracker) ⭐ 2 | 🐛 19 | 🌐 TypeScript | 📅 2026-03-18.

## Clarity Resources

### Developer Tools

* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 353 | 🐛 186 | 🌐 Rust | 📅 2026-03-19 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-20 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [STX20](https://github.com/fess-v/stx20-standard) ⭐ 27 | 🐛 2 | 📅 2024-09-05 - Protocol to create and share digital artifacts on Stacks.
* [clarity-bitcoin](https://github.com/friedger/clarity-bitcoin) ⭐ 20 | 🐛 4 | 🌐 Clarity | 📅 2025-06-04 - A library to verify Bitcoin transactions.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 972 | 🐛 86 | 🌐 TypeScript | 📅 2026-03-14 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
* [Stacks Connect](https://github.com/stx-labs/connect) ⭐ 87 | 🐛 47 | 🌐 TypeScript | 📅 2026-03-12 - A library for connecting apps with Stacks accounts.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 972 | 🐛 86 | 🌐 TypeScript | 📅 2026-03-14 - Command line interface for interacting with auth, storage, and transactions.

### Indexing and Querying APIs

* [Self-Hosted Docker](https://github.com/stacks-network/stacks-blockchain-docker) ⭐ 35 | 🐛 15 | 🌐 Shell | 📅 2026-03-12 - Tool to run a self-hosted Stacks node with Docker.
...
We welcome community contributions to this list. Please read the [contribution guidelines](origin/contributing.md) before contributing.
