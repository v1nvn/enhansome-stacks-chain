...
* [Stacking Tracker](https://stacking-tracker.com) - Overview of Stacking and historical data [Source code](https://github.com/StackingDAO/stacking-tracker) ⭐ 2 | 🐛 21 | 🌐 TypeScript | 📅 2026-03-18.

## Clarity Resources

### Developer Tools

* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 352 | 🐛 187 | 🌐 Rust | 📅 2026-04-16 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-18 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [STX20](https://github.com/fess-v/stx20-standard) ⭐ 26 | 🐛 2 | 📅 2024-09-05 - Protocol to create and share digital artifacts on Stacks.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 973 | 🐛 83 | 🌐 TypeScript | 📅 2026-04-17 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 973 | 🐛 83 | 🌐 TypeScript | 📅 2026-04-17 - Command line interface for interacting with auth, storage, and transactions.

### Indexing and Querying APIs

* [Self-Hosted Docker](https://github.com/stacks-network/stacks-blockchain-docker) ⭐ 35 | 🐛 15 | 🌐 Shell | 📅 2026-04-09 - Tool to run a self-hosted Stacks node with Docker.
