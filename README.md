...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 354 | 🐛 187 | 🌐 Rust | 📅 2026-04-27 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 973 | 🐛 89 | 🌐 TypeScript | 📅 2026-04-27 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 973 | 🐛 89 | 🌐 TypeScript | 📅 2026-04-27 - Command line interface for interacting with auth, storage, and transactions.
