...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 353 | 🐛 179 | 🌐 Rust | 📅 2026-05-15 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 3 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-17 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 973 | 🐛 95 | 🌐 TypeScript | 📅 2026-05-15 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 973 | 🐛 95 | 🌐 TypeScript | 📅 2026-05-15 - Command line interface for interacting with auth, storage, and transactions.
