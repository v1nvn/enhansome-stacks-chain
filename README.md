...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 351 | 🐛 182 | 🌐 Rust | 📅 2026-03-09 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-10 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Self-Hosted Docker](https://github.com/stacks-network/stacks-blockchain-docker) ⭐ 35 | 🐛 15 | 🌐 Shell | 📅 2026-03-09 - Tool to run a self-hosted Stacks node with Docker.
