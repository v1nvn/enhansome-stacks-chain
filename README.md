...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 352 | 🐛 182 | 🌐 Rust | 📅 2026-05-22 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 4 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-27 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 976 | 🐛 88 | 🌐 TypeScript | 📅 2026-05-27 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 976 | 🐛 88 | 🌐 TypeScript | 📅 2026-05-27 - Command line interface for interacting with auth, storage, and transactions.
