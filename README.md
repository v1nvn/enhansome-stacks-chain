...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 347 | 🐛 174 | 🌐 Rust | 📅 2026-02-07 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-08 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 971 | 🐛 84 | 🌐 TypeScript | 📅 2025-12-16 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 971 | 🐛 84 | 🌐 TypeScript | 📅 2025-12-16 - Command line interface for interacting with auth, storage, and transactions.
