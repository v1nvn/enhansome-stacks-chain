...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 352 | 🐛 193 | 🌐 Rust | 📅 2026-03-31 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-01 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 973 | 🐛 88 | 🌐 TypeScript | 📅 2026-03-31 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 973 | 🐛 88 | 🌐 TypeScript | 📅 2026-03-31 - Command line interface for interacting with auth, storage, and transactions.

### Indexing and Querying APIs

* [Self-Hosted Docker](https://github.com/stacks-network/stacks-blockchain-docker) ⭐ 36 | 🐛 15 | 🌐 Shell | 📅 2026-03-27 - Tool to run a self-hosted Stacks node with Docker.
