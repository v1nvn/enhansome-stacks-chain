...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 352 | 🐛 181 | 🌐 Rust | 📅 2026-05-20 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 3 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-21 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 974 | 🐛 93 | 🌐 TypeScript | 📅 2026-05-21 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 974 | 🐛 93 | 🌐 TypeScript | 📅 2026-05-21 - Command line interface for interacting with auth, storage, and transactions.
