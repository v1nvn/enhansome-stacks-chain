...
* [Stacking Tracker](https://stacking-tracker.com) - Overview of Stacking and historical data [Source code](https://github.com/StackingDAO/stacking-tracker) ⭐ 2 | 🐛 21 | 🌐 TypeScript | 📅 2026-05-04.

## Clarity Resources

### Developer Tools

* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 354 | 🐛 184 | 🌐 Rust | 📅 2026-04-29 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-05 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 973 | 🐛 92 | 🌐 TypeScript | 📅 2026-04-30 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 973 | 🐛 92 | 🌐 TypeScript | 📅 2026-04-30 - Command line interface for interacting with auth, storage, and transactions.
