...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 352 | 🐛 184 | 🌐 Rust | 📅 2026-06-12 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 5 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-14 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [clarity-bitcoin](https://github.com/friedger/clarity-bitcoin) ⭐ 19 | 🐛 4 | 🌐 Clarity | 📅 2025-06-04 - A library to verify Bitcoin transactions.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 975 | 🐛 88 | 🌐 TypeScript | 📅 2026-06-12 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 975 | 🐛 88 | 🌐 TypeScript | 📅 2026-06-12 - Command line interface for interacting with auth, storage, and transactions.
...
* [Stacks Monitoring](https://github.com/alexlmiller/stacks-monitoring) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-05-27 - Grafana Dashboard for Stacks nodes.
