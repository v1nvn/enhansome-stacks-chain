...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 353 | 🐛 187 | 🌐 Rust | 📅 2026-06-02 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 4 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-03 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 975 | 🐛 89 | 🌐 TypeScript | 📅 2026-06-02 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 975 | 🐛 89 | 🌐 TypeScript | 📅 2026-06-02 - Command line interface for interacting with auth, storage, and transactions.
