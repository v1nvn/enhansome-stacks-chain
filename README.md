...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 354 | 🐛 183 | 🌐 Rust | 📅 2026-04-29 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-04 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 973 | 🐛 91 | 🌐 TypeScript | 📅 2026-04-30 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 973 | 🐛 91 | 🌐 TypeScript | 📅 2026-04-30 - Command line interface for interacting with auth, storage, and transactions.
